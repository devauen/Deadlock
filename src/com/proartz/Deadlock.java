...
public class Deadlock {
    static class Friend{
        ...
        public void bow(Friend bower){
            if(impendingBow(bower)){
                try {
                    System.out.format("%s: %s has bow to me!%n",
                ...
                System.out.format("%s: %s started to bow to me, " +
                        "but saw i was already bowing to him.%n", this.getName(), bower.getName());
            }
    ...
    public static void main(String[] args) {
        ...
        new Thread(new BowLoop(alfonso, gatsby)).start();
        new Thread(new BowLoop(gatsby, alfonso)).start();
    }
}
